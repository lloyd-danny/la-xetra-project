...
class XetraSourceConfig(NamedTuple):
    ...
    src_col_min_price: column name for minimum price
    src_col_max_price: column name for maximum price
    src_col_traded_vol: column name for traded volume
    """
...
class XetraTargetConfig(NamedTuple):
    ...
    trg_col_min_price: column name for minium price in target
...
class XetraETL():
    """
    Reads the Xetra data, tranforms and writes the transformed data to target
    """
